...
import static com.grammr.language.service.v1.translation.semantic.Prompts.SYSTEM_PROMPT;
import static com.grammr.language.service.v1.translation.semantic.Prompts.USER_PROMPT;
...
public class OpenAIResponsesSemanticTranslationService extends OpenAIResponsesService implements PhraseTranslationService {
  ...
  public Translation translate(String phrase, LanguageCode targetLanguage, LanguageCode sourceLanguage) {
    ...
    return new Translation(phrase, responseText, sourceLanguage, targetLanguage);
  }
