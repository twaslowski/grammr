...
public class AnalysisController {
  ...
  public ResponseEntity<FullAnalysis> processAnalysisRequest(@RequestBody AnalysisRequest request) {
    var fullAnalysis = analysisService.processFullAnalysisRequest(request);
