...
from analysis.domain.grammatical_analysis import GrammaticalAnalysis, AnalysisToken
...
def _create_response(tokens: list[Token], request: AnalysisRequest) -> GrammaticalAnalysis:
