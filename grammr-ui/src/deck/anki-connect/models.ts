  ...
  await fetch('http://localhost:8765', {
    ...
    body: JSON.stringify({
      ...
      params: {
        ...
        inOrderFields: ['lemma', 'translation', 'partOfSpeech', 'inflections'],
