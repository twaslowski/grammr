      ...
      <div className='mb-12'>
        ...
        {activeTab === 'service' && (
          <div>
            ...
            <p className='mb-4'>
              ...
              vocabulary. It supports a variety of languages and is built with a
              focus on accessibility and ease of use. Grammr enables its users
              to translate, practice, and learn new languages with confidence by
              providing information on phrases, named entities and cultural
            ...
            <p className='mb-4'>
              ...
              experience are encouraged to contribute to the project. If you're
              interested, feel free to read more in the Open Source section or
              reach out directly.
            </p>
          </div>
        )}
        ...
        {activeTab === 'open-source' && (
          <div>
            ...
            <p className='mb-4'></p>
            <p className='mb-4'>
              The backend powering this website, grammr-core, is licensed under
        ...
        {activeTab === 'author' && (
          <div>
            ...
            <p className='mb-6'>
              Tobias is a software engineer, open source enthusiast and language
              learner based in Hamburg, Germany.
            </p>
